...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy com.motorola.frameworks.core.addon framework oem-services services telephony-common wifi-service
...
override_property += \
    ...
    ro.product.model_romer=Moto X Pro_Po_Chan
